				...
				<!-- Intro -->
					<section id="intro" class="wrapper style1 fullscreen fade-up">
						<div class="inner">
							...
							<ul class="actions">
								<input type="text" id="findjob" placeholder="Escreva aqui" 
									   style="width: 50%; min-width: 300px;"/>
								
								<li><a href="#one" class="button scrolly" style="display: flex;">
									<div style="">
								...
								<div class="inner" align="center">
									...
									<div class="row" align="center" style="display: block;">  
										...
										<div class="col-5 col-12-xsmall" style="margin-top: 0.5em;">
											<input type="password" name="demo-name" id="demo-name" value="" placeholder="Senha">
										</div>
										<div class="col-5 col-12-xsmall" style="margin-top: 0.5em;">
											<a href="#" class="button icon fa-check" style="width: 50%;">Entrar</a>
										</div>
										<div class="col-5 col-12-xsmall" style="margin-top: 0.5em;">
											<a href="JAVASCRIPT:Cadastrar(1);" class="button icon fa-book" style="width: 50%;">Cadastrar</a>
										</div>
							...
							<div class="content">
								<div class="inner" align="center">
									...
									<div class="row" align="center" style="display: block;">  									<div class="col-5 col-12-xsmall" >
										...
										<div class="col-5 col-12-xsmall" style="margin-top: 0.5em;">
											<a href="#" class="button icon fa-book" style="width: 50%;">Cadastrar</a>
										</div>
										<div class="col-5 col-12-xsmall" style="margin-top: 0.5em;">
											<a href="JAVASCRIPT:Cadastrar(0);" class="button icon fa-check" 
											   style="width: 50%;">Login</a>
										</div>
